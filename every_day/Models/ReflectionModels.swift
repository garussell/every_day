...
enum MoodPromptLibrary {
    ...
    static let all: [String] = [
        ...
        "What emotion is most present today?",
        "What triggered your current mood?",
        "What do you need right now?",
        "What would shift how you feel?",
        ...
        "What does your inner voice need to say right now?",
        "What feeling have you been avoiding?",
        "What would self compassion look like right now?",
        "What are you afraid to admit you are feeling?",
    ]
...
enum GeneralPromptLibrary {
    ...
    static let all: [String] = [
        ...
        "Describe your day in three words then expand on one.",
